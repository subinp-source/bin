...
public class DistributedImpexIntegrationTest extends ServicelayerBaseTest
{
	...
	private static class ImportMetadataAssert extends AbstractAssert<ImportMetadataAssert, String>
	{
		private final ImportMetadata metadata;

		protected ImportMetadataAssert(final String metadataString)
		{
			super(metadataString, ImportMetadataAssert.class);
	...
	private static class ImportMetadataValueAssert extends AbstractAssert<ImportMetadataValueAssert, String>
	{

		protected ImportMetadataValueAssert(final String actual)
		{
			super(actual, ImportMetadataValueAssert.class);
		}

...
public class PLA_12491_Test extends ServicelayerBaseTest
{
	...
	String createTestLines(final int amount, final int errorPos, final String errorCode)
	{
	...
	static class TestMTIR extends MultiThreadedImpExImportReader
	{
		...
		@Override
		protected Item processValueLineFromWorker(final ValueLine line) throws ImpExException
		{
		...
		protected boolean isErrorLine(final ValueLine valueLine)
		{

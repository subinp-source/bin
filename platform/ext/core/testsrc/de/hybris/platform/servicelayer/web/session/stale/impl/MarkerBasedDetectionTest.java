...
public class MarkerBasedDetectionTest
{
	...
	private final String SOME_PASSWORD_MARKER = MarkerBasedDetection.calculateMarker(SOME_PASSWORD);

	private final String ANOTHER_USER_ID = "another.user";
	private final String ANOTHER_PASSWORD = "another.password";
	private final String ANOTHER_PASSWORD_MARKER = MarkerBasedDetection.calculateMarker(ANOTHER_PASSWORD);

	private final String NULL_PASSWORD_MARKER = MarkerBasedDetection.calculateMarker(null);

	@Test
	public void shouldNotModifyMarkerForAnonymousSessionWhenMarkerWasNotSet()
	{
		final SessionContext sessionContext = mockSessionContext("S_1", ANONYMOUS_USER_ID, null, null);

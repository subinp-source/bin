...
public class LockPerformanceTest
{
	...
	private long getReentrantLockCount(final int THREADS, final int durationSeconds)
	{
		...
		final de.hybris.platform.test.RunnerCreator<ReentrantLockRunner> creator = new de.hybris.platform.test.RunnerCreator<ReentrantLockRunner>()
		{
			@Override
		...
		final TestThreadsHolder<ReentrantLockRunner> threads = new TestThreadsHolder<>(THREADS, creator);
	...
	private long getSynchronizedLockCount(final int THREADS, final int durationSeconds)
	{
		...
		final de.hybris.platform.test.RunnerCreator<SyncLockRunner> creator = new de.hybris.platform.test.RunnerCreator<SyncLockRunner>()
		{
			@Override
		...
		final TestThreadsHolder<SyncLockRunner> threads = new TestThreadsHolder<>(THREADS, creator);

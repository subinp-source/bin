...
public class DefaultGenericSearchServiceTest extends ServicelayerTransactionalBaseTest
{
	...
	{
		ProductModel productWithBrackets1 = makeProductWithBrackets("prodWithBrackets1", "test[abc]");
		ProductModel productWithBrackets2 = makeProductWithBrackets("prodWithBrackets2", "[123]abc");
		ProductModel productWithBrackets3 = makeProductWithBrackets("prodWithBrackets3", "test[product-123]");
		...
		Collection productsFoundWithSearchStringInBrackets = genericSearchService.search(gsquery).getResult();
	...
	{
		ProductModel result = modelService.create(ProductModel.class);
		result.setCode(code);
		result.setName(name);
		result.setCatalogVersion(catalogVersionModel);

...
public class UserManagerTokenGeneratorTest  extends ServicelayerBaseTest
{
	...
	public void shouldNotFailOnPartiallyInvalidToken() throws Exception
	{
		...
		tokenExtendedSwitcher.switchToValue("true");
		final String partialyInvalidToken = employee.getPk().toString() + "_" + "dummyLangIsoCode"+ "_" + UUID.randomUUID().toString();
		final CookieBasedLoginToken cookieFromToken = encryptAndGenerateCookieBasedLogenToken(partialyInvalidToken);
	...
	public void shouldNotFailWhenTTLTimestampIsBroken() throws Exception
	{
		...
		final String partialyInvalidToken = employee.getPk().toString() + "_" + langString + "_" + password + "_" + "invalidTTL" + "_" + UUID.randomUUID();

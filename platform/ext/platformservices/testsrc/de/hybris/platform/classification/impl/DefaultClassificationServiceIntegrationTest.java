...
public class DefaultClassificationServiceIntegrationTest extends ServicelayerTransactionalTest
{
	 ...
	 */
	private static class FeatureListAssert extends AbstractAssert<FeatureListAssert, FeatureList>
	{
		public FeatureListAssert(final FeatureList list)
		{
			super(list, FeatureListAssert.class);
		}
	...
	private static class FeatureValuesAssert extends AbstractAssert<FeatureValuesAssert, List<FeatureValue>>
	{
		public FeatureValuesAssert(final List<FeatureValue> fValues)
		{
			super(fValues, FeatureValuesAssert.class);
		}

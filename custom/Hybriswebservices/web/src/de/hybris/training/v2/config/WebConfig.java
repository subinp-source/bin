...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "Hybriswebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "Hybriswebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "Hybriswebservices.oauth2.tokenUrl";

	private static final String DESC = "Hybriswebservices.v2.description";
	private static final String TITLE = "Hybriswebservices.v2.title";
	private static final String VERSION = "Hybriswebservices.v2.version";
	private static final String LICENSE = "Hybriswebservices.v2.license";
	private static final String LICENSE_URL = "Hybriswebservices.v2.license.url";

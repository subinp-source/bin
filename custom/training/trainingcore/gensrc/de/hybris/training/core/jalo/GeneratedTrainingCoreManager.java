...
public abstract class GeneratedTrainingCoreManager extends Extension
{
	...
	public DealerBase createDealerBase(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.DEALERBASE );
			return (DealerBase)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating DealerBase : "+e.getMessage(), 0 );
		}
	}
	
	public DealerBase createDealerBase(final Map attributeValues)
	{
		return createDealerBase( getSession().getSessionContext(), attributeValues );
	}
	
	public DriverBase createDriverBase(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.DRIVERBASE );
			return (DriverBase)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating DriverBase : "+e.getMessage(), 0 );
		}
	}
	
	public DriverBase createDriverBase(final Map attributeValues)
	{
		return createDriverBase( getSession().getSessionContext(), attributeValues );
	}
	...
	public VehicleBase createVehicleBase(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.VEHICLEBASE );
			return (VehicleBase)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating VehicleBase : "+e.getMessage(), 0 );
		}
	}
	
	public VehicleBase createVehicleBase(final Map attributeValues)
	{
		return createVehicleBase( getSession().getSessionContext(), attributeValues );
	}

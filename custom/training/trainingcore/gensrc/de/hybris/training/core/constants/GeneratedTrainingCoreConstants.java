...
public class GeneratedTrainingCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String DEALERBASE = "DealerBase".intern();
	...
	{
		public static final String DRIVERBASE2DEALERBASE = "DriverBase2DealerBase".intern();
		public static final String DRIVERBASE2VEHICLEBASE = "DriverBase2VehicleBase".intern();
		public static final String VEHICLEBASE2DEALERBASE = "VehicleBase2DealerBase".intern();
	}

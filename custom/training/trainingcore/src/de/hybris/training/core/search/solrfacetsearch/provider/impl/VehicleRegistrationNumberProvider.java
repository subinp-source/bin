...
public class VehicleRegistrationNumberProvider extends AbstractPropertyFieldValueProvider implements
        FieldValueProvider {
    ...
    private Collection<? extends FieldValue> createFieldValue(VehicleBaseModel vehicleBaseModel, IndexedProperty indexedProperty) {
        ...
        final String vehicleRegistrationNumber = vehicleBaseModel.getVehicleRegistrationNumber();



        if (vehicleRegistrationNumber !=null){

            addFieldValues(fieldValues,indexedProperty,vehicleRegistrationNumber);
    ...
    private void addFieldValues(List<FieldValue> fieldValues, IndexedProperty indexedProperty,String value) {

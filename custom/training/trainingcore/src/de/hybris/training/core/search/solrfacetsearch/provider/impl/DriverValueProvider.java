...
public class DriverValueProvider extends AbstractPropertyFieldValueProvider implements
        FieldValueProvider {
    ...
    private Collection<? extends FieldValue> createFieldValue(VehicleBaseModel vehicleBaseModel, IndexedProperty indexedProperty) {
        ...
        final String driver = vehicleBaseModel.getDriver().getNameOfDriver();



        if (driver !=null){

            addFieldValues(fieldValues,indexedProperty,driver);

 ...
 */
package de.hybris.training.v1.controller;

import static de.hybris.training.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
import de.hybris.training.formatters.WsDateFormatter;
import de.hybris.training.product.data.ProductDataList;
import de.hybris.training.product.data.SuggestionDataList;
import de.hybris.training.queues.data.ProductExpressUpdateElementData;
import de.hybris.training.queues.data.ProductExpressUpdateElementDataList;
import de.hybris.training.queues.impl.ProductExpressUpdateQueue;
import de.hybris.training.stock.CommerceStockFacade;
import de.hybris.training.util.ws.SearchQueryCodec;
import de.hybris.training.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link de.hybris.training.populator.HttpRequestReviewDataPopulator} to populate review data

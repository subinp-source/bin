...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "hybriscommercewebservice.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "hybriscommercewebservice.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "hybriscommercewebservice.oauth2.tokenUrl";

	private static final String DESC = "hybriscommercewebservice.v2.description";
	private static final String TITLE = "hybriscommercewebservice.v2.title";
	private static final String VERSION = "hybriscommercewebservice.v2.version";
	private static final String LICENSE = "hybriscommercewebservice.v2.license";
	private static final String LICENSE_URL = "hybriscommercewebservice.v2.license.url";

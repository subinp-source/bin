...
public class DefaultSubscriptionCommerceCartServiceIntegrationTest extends DefaultCommerceCartServiceIntegrationTest
{
	...
	public void testUpdateQuantityForMultiCartEntry() throws CommerceCartModificationException
	{
		...
		final Integer productEntryNo = subscriptionCommerceCartService
				.addToCart(telcoMasterCart, productModel, 1, unitModel, false).getEntry().getEntryNumber();
		final Integer subscriptionProductMonthlyEntryNo1 = subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelMonthly, 1, unitModel, true).getEntry()
				.getEntryNumber();
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelQuarterly, 1, unitModel, false).getEntry()
				.getEntryNumber();
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelYearly, 1, unitModel, false)
				.getEntry().getEntryNumber();
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelMonthly, 1, unitModel, false).getEntry()
				.getEntryNumber();
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelQuarterly, 1, unitModel, false).getEntry()
				.getEntryNumber();
		subscriptionCommerceCartService
				...
				.getEntry().getEntryNumber();
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelPaynow, 1, unitModel, false)
				.getEntry().getEntryNumber();
	...
	public void testAddToMultiCart() throws CommerceCartModificationException
	{
		...
		subscriptionCommerceCartService.addToCart(telcoMasterCart, productModel, 1, unitModel, false);
		...
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelMonthly, 1, unitModel, true)
				.getEntry();
		...
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelMonthly, 1, unitModel, false);
	...
	public void testRemoveAllEntriesMultiCart() throws CommerceCartModificationException
	{
		...
		subscriptionCommerceCartService.addToCart(telcoMasterCart, productModel, 1, unitModel, false);
		subscriptionCommerceCartService.addToCart(telcoMasterCart, productModel, 1, unitModel, false);
		subscriptionCommerceCartService.addToCart(telcoMasterCart, productModel, 1, unitModel, true);
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelMonthly, 1, unitModel, true);
		subscriptionCommerceCartService
				.addToCart(telcoMasterCart, subscriptionProductModelMonthly, 1, unitModel, false);
	...
	private void setupProducts()
	{
		...
		subscriptionProductModelQuarterly = productService
				.getProductForCode(catalogVersionModel, SUBSCRIPTION_PRODUCT_CODE_QUARTERLY);

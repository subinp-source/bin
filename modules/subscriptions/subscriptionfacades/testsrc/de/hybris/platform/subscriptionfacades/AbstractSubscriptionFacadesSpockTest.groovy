...
import static de.hybris.platform.subscriptionfacades.util.XmlAssertions.assertXPathEvaluatesTo
 ...
 */
@Component
abstract class AbstractSubscriptionFacadesSpockTest extends AbstractCommerceFacadesSpockTest {
	...
	@Resource
	private CommerceCartService subscriptionCommerceCartService
	...
	public void verifyClonedChildCarts(final String originalCartCode, final String clonedCartCode) {
		final CartModel originalMasterCartModel = subscriptionCommerceCartService.getCartForCodeAndUser(originalCartCode,
				userService.getCurrentUser());
		final CartModel clonedMasterCartModel = subscriptionCommerceCartService.getCartForCodeAndUser(clonedCartCode,
				userService.getCurrentUser());

...
public class DefaultB2BCurrencyConversionServiceMockTest extends HybrisMokitoTest
{
	...
	public void testFormatCurrencyAmount() throws Exception
	{
		...
		final String formattedAmount = defaultB2BConversionService.formatCurrencyAmount(Locale.CANADA, currency, amount);
		assertThat(formattedAmount, equalTo("US$93.21"));

...
public class Customers extends AbstractItems<CustomerModel>
{
	...
	{
		return getOrSaveAndReturn(() -> getOmsCustomerDao().getByCode(uid), () -> CustomerModelBuilder.aModel().withUid(uid)
				.withName(name).build());
	}

	public CustomerDaoImpl getOmsCustomerDao()
	{
		return omsCustomerDao;
	}

	@Required
	public void setOmsCustomerDao(final CustomerDaoImpl omsCustomerDao)
	{

...
public class DefaultPermissionsFacadeIntegrationTest extends ServicelayerTest
{
	...
	static
	{
		...
		CHANGE_FALSE_PERMISSIONS = new HashMap<>();
		...
		GLOBAL_TRUE_PERMISSIONS = new HashMap<>();
		GLOBAL_TRUE_PERMISSIONS.put(GLOBAL_PERMISSION, TRUE);

		GLOBAL_FALSE_PERMISSIONS = new HashMap<>();
	...
	public void testCalculateTypesPermissionsForAdmin()
	{
		...
		//then
		final List<PermissionsData> expected = new ArrayList<>();
	...
	{
		//given
		final List<String> permissionNames = new ArrayList<>(allPermissionNameList);
		permissionNames.addAll(allPermissionNameList);

		//when
		final List<PermissionsData> permissionsList = defaultPermissionsFacade.calculateTypesPermissions(USER1,
				userAndOrderTypeList, permissionNames);
	...
	{
		//given
		final List<String> types = new ArrayList<>(userAndOrderTypeList);
		types.addAll(userAndOrderTypeList);

		//when
		final List<PermissionsData> permissionsList = defaultPermissionsFacade.calculateTypesPermissions(USER1,
				types, allPermissionNameList);
	...
	public void testCalculateAttributesPermissionsForDuplicatePermissions()
	{
		...
		//when
		final List<PermissionsData> permissionsList = defaultPermissionsFacade.calculateAttributesPermissions(USER1,
				itemAttributeList, permissionNames);
	...
	{
		//given
		final List<String> attributes = new ArrayList<>(itemAttributeList);
		attributes.addAll(itemAttributeList);

		//when
		final List<PermissionsData> permissionsList = defaultPermissionsFacade.calculateAttributesPermissions(USER1,
				attributes, allPermissionNameList);
	...
	public void testCalculateGlobalPermissionsForDuplicatePermissions()
	{
		//given
		addGlobalPermission(USER1, GLOBAL_PERMISSION);
		final List<String> permissions = new ArrayList<>(globalPermissionList);
		permissions.addAll(globalPermissionList);

		//when
		final PermissionsData permissionsData = defaultPermissionsFacade.calculateGlobalPermissions(USER1, permissions);
	...
	public void testCalculateCatalogPermissionsForSuperGroup()
	{
		...
		//then
		final List<CatalogPermissionsData> expected = new ArrayList<>();
	...
	public void testCalculateCatalogPermissionsForDuplicateCatalogs()
	{
		...
		//when
		final List<CatalogPermissionsData> permissionsDataList = defaultPermissionsFacade.calculateCatalogPermissions(USER1,
				catalogs, Arrays.asList(STAGED_VERSION, ONLINE_VERSION));
	...
	public void testCalculateCatalogPermissionsForDuplicateCatalogVersions()
	{
		...
		versions.add(STAGED_VERSION);
		versions.add(ONLINE_VERSION);
		versions.add(ONLINE_VERSION);

		//when
		final List<CatalogPermissionsData> permissionsDataList = defaultPermissionsFacade.calculateCatalogPermissions(USER1,
				Collections.singletonList(CATALOG1), versions);

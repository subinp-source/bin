...
public class DefaultPromotionEngineServiceTest extends PromotionEngineServiceBaseTest
{
	...
	{
		final String fileName = legacyRRDMode ? "orderPercentageDiscount_rrd" : "orderPercentageDiscount";
		...
		// change the rule...
		final String fileNameChanged = legacyRRDMode ? "orderPercentageDiscount1_rrd" : "orderPercentageDiscount1";

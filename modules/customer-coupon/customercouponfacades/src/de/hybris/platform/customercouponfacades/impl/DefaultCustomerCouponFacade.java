...
public class DefaultCustomerCouponFacade implements CustomerCouponFacade
{
	...
	@Override
	public CustomerCouponNotificationData saveCouponNotification(final String couponCode)
	{
		return getCustomerCouponService().saveCouponNotification(couponCode)
				.map(model -> getCustomerCouponNotificationConverter().convert(model)).orElse(null);
	}
	...
	{
		return customerCouponNotificationConverter;
	}

	public void setCustomerCouponNotificationConverter(
			final Converter<CouponNotificationModel, CustomerCouponNotificationData> customerCouponNotificationConverter)
	{

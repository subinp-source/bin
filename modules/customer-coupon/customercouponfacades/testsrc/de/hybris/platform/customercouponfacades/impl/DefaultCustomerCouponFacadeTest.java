...
public class DefaultCustomerCouponFacadeTest
{
	...
	public void testNotification(){
		...
		Mockito.when(customerCouponService.saveCouponNotification(COUPON_ID)).thenReturn(Optional.of(notificationModel));
		Mockito.when(customerCouponNotificationConverter.convert(notificationModel)).thenReturn(notificationData);

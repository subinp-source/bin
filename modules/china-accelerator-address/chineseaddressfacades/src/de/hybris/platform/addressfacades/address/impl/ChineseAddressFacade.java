...
public class ChineseAddressFacade implements AddressFacade
{
	...
	private CellphoneValidateStrategy cellphoneValidateStrategy;
	...
	{
		return getCellphoneValidateStrategy().isInvalidCellphone(cellphone);
	}
	...
	{
		return cellphoneValidateStrategy;
	}

	@Required
	public void setCellphoneValidateStrategy(final CellphoneValidateStrategy cellphoneValidateStrategy)
	{
		this.cellphoneValidateStrategy = cellphoneValidateStrategy;
	}

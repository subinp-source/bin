...
public class ChineseUnitAddressValidator extends AddressValidator
{
	...
	public void validate(final Object object, final Errors errors)
	{
		...
		if (!errors.hasFieldErrors(ChineseUnitAddressForm.ATTR_CELLPHONE) && addressFacade.isInvalidCellphone(cellphone))
		{
			errors.rejectValue(ChineseUnitAddressForm.ATTR_CELLPHONE, "address.cellphone.invalid");
		}
	}
}

...
public class ProductConfigurationServiceImpl implements ProductConfigurationService
{
	...
	private static Map<String, Object> locks = new HashMap<>((int) (maxLocksPerMap / MAP_INITIAL_CAPACITY_CALCULATE_DIVISOR + 1));
	private static Map<String, Object> oldLocks = new HashMap<>(

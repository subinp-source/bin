...
public class ChineseMobileBindingController extends AbstractPageController
{
	...
	private Validator mobileNumberValidator;
	...
	{
		mobileNumberValidator.validate(form, bindingResult);
	...
	{
		mobileNumberValidator.validate(verificationCodeForm, bindingResult);
		if (bindingResult.hasErrors())
		{

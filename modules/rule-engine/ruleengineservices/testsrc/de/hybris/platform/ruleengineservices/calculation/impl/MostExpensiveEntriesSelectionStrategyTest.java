 ...
 */
@UnitTest
public class MostExpensiveEntriesSelectionStrategyTest extends AbstractRuleEngineTest
{
	private final MostExpensiveEntriesSelectionStrategy selector = new MostExpensiveEntriesSelectionStrategy();
	...
	public void testPickup2OrderEntries()
	{
		...
		final OrderEntryRAO orderEntry1 = createOrderEntryRAO(cartRao1, "15.00", USD, orderEntry1_unitQuantity);
		final OrderEntryRAO orderEntry2 = createOrderEntryRAO(cartRao1, "10.00", USD, 3);
		final EntriesSelectionStrategyRPD selectionStrategy1 = createEntriesSelectionStrategyRPD(
				OrderEntrySelectionStrategy.MOST_EXPENSIVE, toPickupUnitQuantity, false, orderEntry1, orderEntry2);

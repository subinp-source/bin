...
public class GenericConditionQueryBuilderIntegrationTest extends ServicelayerTransactionalTest
{
	...
	@Test
	public void shouldConditionBeCaseInsensitiveWhenSimpleSearchPerformedAndCaseSensitivePropertyIsFalse()
	{
		// given
		final GenericQuery genericQuery = new GenericQuery(TYPE_CODE);
		final SearchQueryData searchQueryData = prepareSearchQueryData(AdvancedSearchMode.SIMPLE);

		Config.setParameter(PROPERTY_SIMPLESEARCH_CASESENSITIVE, "false");
		...
		// then
		final GenericValueCondition returnedCondition = (GenericValueCondition) genericConditions.get(0);
		assertThat(returnedCondition.isCaseInsensitive()).isTrue();
	}

	@Test
	public void shouldConditionBeCaseSensitiveWhenSimpleSearchPerformedAndCaseSensitivePropertyIsTrue()
	{
		// given
		final GenericQuery genericQuery = new GenericQuery(TYPE_CODE);
		final SearchQueryData searchQueryData = prepareSearchQueryData(AdvancedSearchMode.SIMPLE);

		Config.setParameter(PROPERTY_SIMPLESEARCH_CASESENSITIVE, "true");
		...
		// then
		final GenericValueCondition returnedCondition = (GenericValueCondition) genericConditions.get(0);
		assertThat(returnedCondition.isCaseInsensitive()).isFalse();
	}

	@Test
	public void shouldConditionBeCaseInsensitiveWhenAdvancedSearchPerformedAndCaseSensitivePropertyIsFalse()
	{
		// given
		final GenericQuery genericQuery = new GenericQuery(TYPE_CODE);
		final SearchQueryData searchQueryData = prepareSearchQueryData(AdvancedSearchMode.ADVANCED);

		Config.setParameter(PROPERTY_ADVANCEDSEARCH_CASESENSITIVE, "false");
	...
	@Test
	public void shouldConditionBeCaseSensitiveWhenAdvancedSearchPerformedAndCaseSensitivePropertyIsTrue()
	{
		// given
		final GenericQuery genericQuery = new GenericQuery(TYPE_CODE);
		final SearchQueryData searchQueryData = prepareSearchQueryData(AdvancedSearchMode.ADVANCED);

		Config.setParameter(PROPERTY_ADVANCEDSEARCH_CASESENSITIVE, "true");
	...
	@Test
	public void shouldConditionBeCaseInsensitiveWhenSimpleSearchPerformedAndCaseSensitivePropertyIsNotSet()
	{
		// given
		final GenericQuery genericQuery = new GenericQuery(TYPE_CODE);
		final SearchQueryData searchQueryData = prepareSearchQueryData(AdvancedSearchMode.SIMPLE);
	...
	@Test
	public void shouldConditionBeCaseInsensitiveWhenAdvancedSearchPerformedAndCaseSensitivePropertyIsNotSet()
	{
		// given
		final GenericQuery genericQuery = new GenericQuery(TYPE_CODE);
		final SearchQueryData searchQueryData = prepareSearchQueryData(AdvancedSearchMode.ADVANCED);
		Config.setParameter(PROPERTY_ADVANCEDSEARCH_CASESENSITIVE, "");
	...
	private SearchQueryData prepareSearchQueryData(final AdvancedSearchMode mode)
	{
		final AdvancedSearchQueryData.Builder builder = new AdvancedSearchQueryData.Builder(TYPE_CODE);
		builder.advancedSearchMode(mode);

		final List<SearchQueryCondition> searchQueryConditions = new LinkedList<>();
		...
		builder.conditions(searchQueryConditions);

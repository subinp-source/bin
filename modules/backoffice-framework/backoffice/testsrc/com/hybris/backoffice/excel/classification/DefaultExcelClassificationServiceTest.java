...
public class DefaultExcelClassificationServiceTest
{
	...
	public void shouldReturnedValuesBeResultOfUnion()
	{
		...
		assertThat(returnedValue).containsValues(List.of(cpu), List.of(hardware));
	}
	...
	{
		initializeClassificationClass(hardware, hardwareSystemVersion, hardwareSystem, HARDWARE);

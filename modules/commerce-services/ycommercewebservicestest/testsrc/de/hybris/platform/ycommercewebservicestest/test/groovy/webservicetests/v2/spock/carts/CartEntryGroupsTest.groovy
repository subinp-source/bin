...
import static de.hybris.platform.ycommercewebservicestest.setup.TestSetupUtils.anyExtensionPresent
...
class CartEntryGroupsTest extends AbstractCartTest {
	 ...
	 */
	@IgnoreIf({ anyExtensionPresent("ycommercewebservicestest.bundle.extensions") })

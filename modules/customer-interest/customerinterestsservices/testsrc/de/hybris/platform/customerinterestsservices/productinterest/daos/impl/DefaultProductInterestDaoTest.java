...
/**
 * JUnit test suite for {@link ProductInterestDao}
 */
@IntegrationTest
public class DefaultProductInterestDaoTest extends ServicelayerTransactionalTest
{
	...
	public void test_Find_Product_Interests_By_Customer()
	{
		...
		Assert.assertEquals(8, productInterests.size());
	}
	...
	public void test_findProductInterests_with_expired_By_Customer()
	{
		...
		final List<ProductInterestModel> productInterests = productInterestDao.findProductInterests(customer, baseStore, baseSite);
	...
	{
		final List<ProductInterestModel> productIntersts = productInterestDao
				.findProductInterestsByNotificationType(NotificationType.NOTIFICATION);

...
public class FormDefinitionUtils
{
			...
			throws YFormServiceException
	{
		...
		try
		{
			...
			final Document doc = builder.build(IOUtils.toInputStream(content, StandardCharsets.UTF_8));
	...
	{
		private static final CharsetEncoder CHARSET_ENCODER = Charset.forName(StandardCharsets.US_ASCII.name()).newEncoder();

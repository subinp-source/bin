...
public class AbstractYFormFacadeKeywords extends ServicelayerTest {
	...
	private static final Logger LOG = Logger.getLogger(AbstractYFormFacadeKeywords.class);

	private static final String ANONYMOUS_UID = "anonymous";
	private static MessageFormat YFORM_DEFINITION_TEMPLATE = new MessageFormat(
	...
	{
		return YFORM_DEFINITION_TEMPLATE.format(new Object[]

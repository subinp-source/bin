...
public class IntegrationmonitoringbackofficeManager extends GeneratedIntegrationmonitoringbackofficeManager
{
	 ...
	 */
	public static IntegrationmonitoringbackofficeManager getInstance()
	{
		return (IntegrationmonitoringbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(IntegrationmonitoringbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public IntegrationmonitoringbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of IntegrationmonitoringbackofficeManager called.");
		}
	}

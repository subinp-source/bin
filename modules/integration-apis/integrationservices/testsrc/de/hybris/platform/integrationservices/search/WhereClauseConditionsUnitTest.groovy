...
{
	@Shared
	def static final CONDITION_1 = new WhereClauseCondition("{a} = condition1")
	@Shared
	def static final CONDITION_2 = new WhereClauseCondition("{a} = condition2")
	@Shared
	...
	def "join conditions1 #conditions1 and conditions2 #conditions2 with the conjunctive operator #operator"()
	{
		...
		new WhereClauseConditions(CONDITION_3)  | new WhereClauseConditions(CONDITION_4)    | ConjunctiveOperator.AND       | 2     | [new WhereClauseCondition(CONDITION_3.getCondition(), ConjunctiveOperator.AND), CONDITION_4]
		new WhereClauseConditions(CONDITION_3)  | new WhereClauseConditions([])             | ConjunctiveOperator.OR        | 1     | [new WhereClauseCondition(CONDITION_3.getCondition(), ConjunctiveOperator.OR)]

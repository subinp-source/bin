...
public class ODataAdvancedPersistenceFacadeIntegrationTest extends ServicelayerTest
{
	...
	public void testPersistEntity_ImpExImportCronJobModel_NewEntryEntityShouldCreate()
	{
		...
		final String content = JsonBuilder.json()
		                                  ...
		                                  .withField(ATTR_WORK_MEDIA,
				                                  impExMediaContent(testWorkMediaCode, CATALOG_ID, CATALOG_VERSION))
		                                  .build();

		final ODataRequest request = oDataPostRequest(SERVICE, SERVICE_IMPEXIMPORTCRONJOBS, content, Locale.ENGLISH,
	...
	public void testPersistEntity_ImpExMediaModel_WhenIsPartOfFalse_NoNewEntryEntityShouldCreate()
	{
		...
		final ODataRequest request = oDataPostRequest(SERVICE, SERVICE_IMPEXMEDIAS, content, Locale.ENGLISH,
				APPLICATION_JSON_VALUE);
		final ODataResponse oDataResponse = facade.handleRequest(createContext(request));
	...
	public void testPersistEntity_MissingKeyField_transactional_WhenErrorOccursShouldRollback()
	{
		...
		final String content = JsonBuilder.json()
		                                  .withField(ATTR_WORK_MEDIA,
				                                  impExMediaContent(MISSING_KEY_CODE, CATALOG_ID, CATALOG_VERSION))
		                                  .build();

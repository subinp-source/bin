...
public class OutboundsyncbackofficeManager extends GeneratedOutboundsyncbackofficeManager
{
	 ...
	 */
	public static OutboundsyncbackofficeManager getInstance()
	{
		return (OutboundsyncbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(OutboundsyncbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OutboundsyncbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OutboundsyncbackofficeManager called.");
		}
	}

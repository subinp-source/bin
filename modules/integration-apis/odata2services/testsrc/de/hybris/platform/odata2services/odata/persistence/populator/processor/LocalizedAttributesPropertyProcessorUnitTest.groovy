...
class LocalizedAttributesPropertyProcessorUnitTest extends Specification {
	...
	@Test
	@Unroll
	def "processItem ignores property when localizable=#isLocalizable, settable=#isSettable, readable=#readable"() {
		given:
		givenTypeDescriptorAttributeNotFound()
		...
		attributeDescriptor.getReadable() >> readable
		...
		where:
		isSettable | isLocalizable | readable
		true       | false         | true
		false      | true          | true
		true       | true          | false
	}
	...
	def givenTypeDescriptorAttributeNotFound() {
		itemTypeDescriptorService.getTypeDescriptorByTypeCode(_ as String, _ as String) >> Optional.empty()
	}

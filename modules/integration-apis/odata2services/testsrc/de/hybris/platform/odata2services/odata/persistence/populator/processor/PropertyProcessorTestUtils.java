...
public class PropertyProcessorTestUtils
{
	...
	static AbstractPropertyProcessor.PropertyMetadata propertyMetadata(final TypeAttributeDescriptor attributeDescriptor, final String propertyName)
	{
		return AbstractPropertyProcessor.PropertyMetadata.create(attributeDescriptor, propertyName);
	}
}

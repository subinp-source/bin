...
class InboundIntegrationMonitoringIntegrationTest extends ServicelayerSpockSpecification {
    ...
    def setupSpec() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                '; req1 ; ERROR   ; Category; test-error; admin',
                '; req2 ; SUCCESS ; Catalog ; test-success; admin',
    ...
    def "can GET /InboundIntegrationMonitoring/#feed"() {
        ...
        where:
        feed                         | path                | result
        ''                           | 'd.EntitySets'      | ['InboundRequestErrors', 'IntegrationRequestStatuses', 'InboundRequests', 'InboundUsers', 'Localized___InboundUsers']

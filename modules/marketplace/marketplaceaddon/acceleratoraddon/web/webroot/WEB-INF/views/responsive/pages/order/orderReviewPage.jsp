					...
					<div class="order-review-product_list">
						...
						<div class="row">
							<template:errorSpanField path="productReviewForms[${status.index}].comment">
								...
								<div class="col-md-9">
									<textarea name="productReviewForms[${fn:escapeXml(status.index)}].comment" aria-label="product review comment" class="form-control order-review-textarea" rows="5">${fn:escapeXml(orderReviewForm.productReviewForms[status.index].comment)}</textarea>
								</div>
							</template:errorSpanField>
						</div>
				...
				<div class="order-review-product_list">
					...
					<div class="row">
							<template:errorSpanField path="comment">
								...
								<div class="col-md-9">
									<textarea name="comment" aria-label="comment" class="form-control order-review-textarea" rows="5">${fn:escapeXml(orderReviewForm.comment)}</textarea>
								</div>
							</template:errorSpanField>
					</div>
				</div>

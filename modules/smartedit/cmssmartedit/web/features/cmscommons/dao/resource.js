...
(function() {
    ...
    angular
         ...
         *
         * @description
         * This service is used to retrieve the IRestClient factor for retrieving component items.
         */
        ...
        .factory('synchronizationResource', function(
            ...
            return {
                getPageSynchronizationGetRestService: function(uriContext) {
                    var getURI = new URIBuilder(GET_PAGE_SYNCHRONIZATION_RESOURCE_URI)
                ...
                getPageSynchronizationPostRestService: function(uriContext) {
                    var postURI = new URIBuilder(POST_PAGE_SYNCHRONIZATION_RESOURCE_URI)
                        .replaceParams(uriContext)
                        .build();

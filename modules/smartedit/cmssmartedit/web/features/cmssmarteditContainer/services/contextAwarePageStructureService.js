 ...
 */
angular
    .module('contextAwarePageStructureServiceModule', [
     ...
     *
     */
    .value('PAGE_STRUCTURE_PRE_ORDER', [
        'typeCode',
        'template',
        'name',
        'description',
     ...
     *
     */
    .service('contextAwarePageStructureService', function(
        $q,
        typeStructureRestService,
        pageService,
        PAGE_STRUCTURE_PRE_ORDER,
        PAGE_STRUCTURE_POST_ORDER
    ) {
        ...
        function getFields(pageTypeCode) {
            return typeStructureRestService
         ...
         */
        this.getPageStructureForNewPage = function getPageStructureForNewPage(
            pageTypeCode,
            isPrimary
        ) {
         ...
         * @returns {Array} A modified page structure
         */
        this.getPageStructureForPageEditing = function getPageStructureForPageEditing(
            pageTypeCode,
            pageId
        ) {
            return getFields(pageTypeCode).then(function(fields) {

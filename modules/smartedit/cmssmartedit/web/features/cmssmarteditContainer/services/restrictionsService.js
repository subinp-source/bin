 ...
 */
angular
    .module('restrictionsServiceModule', [
    ...
    .service('restrictionsService', function(
         ...
         */
        this.getPagedRestrictionsForType = function(
            restrictionTypeCode,
            mask,
            pageSize,
            currentPage
        ...
        /**
         * @ngdoc method
         * @name restrictionsServiceModule.service:restrictionsService#getSupportedRestrictionTypeCodes
         * @methodOf restrictionsServiceModule.service:restrictionsService
        ...
        this.getSupportedRestrictionTypeCodes = function getSupportedRestrictionTypeCodes() {
            return typeStructureRestService
                .getStructuresByCategory('RESTRICTION')

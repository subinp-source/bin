...
angular
    ...
    .factory('componentVisibilityAlertService', function(
        ...
        ComponentVisibilityAlertService.prototype.checkAndAlertOnComponentVisibility = function(
            component
        ) {
            var I18N = {
            ...
            if (!component.visible || component.restricted) {
                sharedDataService.get('experience').then(
                    function(experience) {
                        var message = !component.visible
                            ? I18N.ITEM_ALERT_HIDDEN
                            : I18N.ITEM_ALERT_RESTRICTED;
                        var isExternal =
                        ...
                        if (isExternal) {
                            ...
                            actionableAlertService.displayActionableAlert({
                                controller: [
                                    'componentVisibilityAlertService',
                                    'editorModalService',
                                    function(componentVisibilityAlertService, editorModalService) {
                                        this.onClick = function() {
                                            var checkProvidedArguments = function() {
                                                ...
                                                if (
                                                    checkedArguments.filter(function(value) {

 ...
 */
angular
    .module('actionableAlertModule', ['alertServiceModule'])
     ...
     * controller.
     **/
    .service('actionableAlertService', function(alertService, actionableAlertConstants) {
        ...
        function getMethodNameByAlertType(alertType) {
            return alertType && alertTypesMapping.hasOwnProperty(alertType)
                ? alertTypesMapping[alertType]
                : alertTypesMapping.INFO;
        }
    });

...
(function() {
     ...
     */
    angular
        .module('pageTemplateServiceModule', ['resourceLocationsModule', 'yLoDashModule'])
         ...
         *
         */
        .factory('pageTemplateService', function(
            restServiceFactory,
            PAGE_TEMPLATES_URI,
            NON_SUPPORTED_TEMPLATES,
            lodash
        ) {
                    ...
                    return pageTemplateRestService.get(params).then(function(pageTemplates) {
                        return {
                            templates: pageTemplates.templates.filter(function(pageTemplate) {
                                return (
                                    NON_SUPPORTED_TEMPLATES.indexOf(pageTemplate.frontEndName) ===
                                    -1
                                );
                            })
                        };

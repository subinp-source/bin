 ...
 */
angular
    .module('selectPageTemplateModule', ['pageTemplateServiceModule', 'l10nModule'])
        ...
        function(pageTemplateService) {
            ...
            this._onInputUpdated = function _onInputUpdated() {
                ...
                if (cache[self.pageTypeCode]) {
                    ...
                    pageTemplateService
                        .getPageTemplatesForType(self.uriContext, self.pageTypeCode)

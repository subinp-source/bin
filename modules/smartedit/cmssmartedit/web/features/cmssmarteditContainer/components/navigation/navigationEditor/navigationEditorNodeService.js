 ...
 */
angular
    .module('navigationEditorNodeServiceModule', [
        'resourceModule',
        'yLoDashModule',
        'functionsModule',
     ...
     */
    .service('navigationEditorNodeService', function(
        $log,
        _nodeAncestryService,
        ...
        this.updateNavigationNodePosition = function(node) {
            return cmsitemsRestService
                .getById(node.parent.uuid)
                .then(function(parentNodeFromServer) {
                    ...
                    if (currentIndex < 0 || node.position === undefined) {
                        throw new Error(
                            'navigationEditorNodeService.updateNavigationNodePosition() - invalid index: move FROM [' +
                                currentIndex +
                                '] TO [' +
                                targetIndex +
                                ']'
                    ...
                    parentNodeFromServer.children.splice(
                        targetIndex,
                        0,
                        parentNodeFromServer.children.splice(currentIndex, 1)[0]
                    );
        ...
        this.getNavigationNodeAncestry = function(nodeUid, uriParams) {
            ...
            return navigationNodeRestService.get(payload).then(function(response) {
                return _nodeAncestryService.buildOrderedListOfAncestors(

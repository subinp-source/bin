 ...
 */
angular
    .module('cmsItemDropdownModule', [
        'nestedComponentModule',
        'smarteditServicesModule',
        'nestedComponentManagementServiceModule',
        'genericEditorModule',
        'cmsItemDropdownDropdownPopulatorModule'
    ])
    .controller('cmsItemDropdownController', function(
        ...
        // Constants
        // -------------------------------------------------------------------------------------------------
        var CREATE_COMPONENT_BUTTON_PRESSED_EVENT_ID =
        ...
        this.createNestedComponent = function(componentType) {
            ...
            return nestedComponentManagementService
                .openNestedComponentEditor(componentInfo, this.editorStackId, null)
                .then(
                    function(item) {

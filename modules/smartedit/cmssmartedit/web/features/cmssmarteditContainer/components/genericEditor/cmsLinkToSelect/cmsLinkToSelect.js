...
angular
    ...
    .controller('CmsLinkToSelectController', function(
        CMS_LINK_TO_SELECT_OPTIONS,
        ...
        this.$onInit = function() {
            ...
            this.unregisterDropdownListener = systemEventService.subscribe(
                this.id + LINKED_DROPDOWN,
                _onLinkToSelectValueChanged.bind(this)
            );
        };

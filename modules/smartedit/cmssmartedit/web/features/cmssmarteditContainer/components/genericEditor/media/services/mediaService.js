 ...
 */
angular
    .module('mediaServiceModule', ['resourceModule', 'resourceLocationsModule', 'functionsModule'])
    /**
     * @ngdoc service
    ...
    .service('mediaService', function(
        ...
        this.getPage = function(mask, pageSize, currentPage, parameters) {
            ...
            var payload = {
                ...
                catalogVersion:
                    this.uriParameters[CONTEXT_CATALOG_VERSION] || CONTEXT_CATALOG_VERSION
            };
            if (!isBlank(mask)) {
                payload.code = mask;
            }

            var subParams = Object.keys(payload)

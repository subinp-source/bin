 ...
 */
angular
    .module('catalogInformationServiceModule', ['cmsSmarteditServicesModule'])
    /**
     * @ngdoc service
     ...
     *
     */
    .service('seCatalogInformationService', function(
        $q,
        lodash,
        catalogService,
        productService,
            ...
            return this._getSiteUID().then(
                function(siteUID) {
                    if (this._cachedSiteUID === siteUID && this._parsedCatalogs) {
                        ...
                        return catalogService.getProductCatalogsForSite(siteUID).then(
                            function(catalogs) {
                                var result = {};
        ...
        this.productsFetchStrategy = {
            fetchPage: function(catalogInfo, _mask, _pageSize, _currentPage) {
                return this._getSiteUID()
                    .then(function(siteUID) {

 ...
 */
angular
    .module('categorySelectorModule', [
        'catalogAwareSelectorModule',
        'catalogInformationServiceModule'
    ])
    /**
     * @ngdoc object
    ...
    .controller('CategorySelectorController', function(
        $q,
        lodash,
        sharedDataService,
        seCatalogInformationService,
        CATEGORY_TEMPLATE_FOR_SELECTOR
    ) {

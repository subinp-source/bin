 ...
 */
angular
    .module('seMediaContainerFieldModule', [
    ...
    .controller('seMediaContainerFieldController', function(
        $log,
        ...
        this.$onInit = function() {
            ...
            this.itemTemplateUrl = 'seAdvancedMediaContainerDropdownItemTemplate.html';
    ...
    .component('seMediaContainerField', {

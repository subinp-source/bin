 ...
 *
 * The page synchronization modal service module provides a service that allows opening an synchronization modal for a given page.
 * The synchronization modal contains a Synchronization Panel.
 */
angular
    .module('syncPageModalServiceModule', ['modalServiceModule', 'synchronizationPanelModule'])
    /**
     * @ngdoc service
     ...
     *
     */
    .factory('syncPageModalService', function(
        modalService,
        ...
        SyncModalService.prototype.open = function(page, uriContext) {
            return modalService.open({
                ...
                templateInline:
                    '<page-synchronization-panel data-on-selected-items-update="modalController.onSelectedItemsUpdate" data-sync-items="modalController.sync" data-uri-context="modalController.uriContext" data-cms-page="modalController.cmsPage" data-show-detailed-info="true"></page-synchronization-panel>',
                controller: [

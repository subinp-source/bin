 ...
 **/
angular
    .module('restrictionPickerModule', [
    ...
    .service('restrictionPickerConfig', function(lodash) {
         ...
         */
        this.getConfigForEditing = function getConfigForEditing(
            existingRestriction,
         ...
         */
        this.getConfigForSelecting = function getConfigForSelecting(
            ...
            switch (config.mode) {
                ...
                case this.MODE_SELECT:
                    if (config.getSupportedRestrictionTypesFn) {
                        return (
                            lodash.isFunction(config.getRestrictionTypesFn) &&

 ...
 */
angular
    .module('restrictionsEditorModule', [
    ...
    .controller('restrictionsEditorController', function(
        ...
        this.setSliderConfigForAddOrCreate = function() {
            ...
            this.sliderPanelConfiguration.modal.save.onClick = function() {
                this.restrictionManagement
                    ...
                    .catch(function() {
                        $log.warn(
                            'restrictionsEditorController.setSliderConfigForAddOrCreate - Failed to create restriction'
                        );
                    });
            }.bind(this);
        }.bind(this);
        ...
        this.setSliderConfigForEditing = function() {
            ...
            this.sliderPanelConfiguration.modal.save.onClick = function() {
                this.restrictionManagement.submitFn().then(
                    function(restrictionEdited) {
                        if (this.restrictionManagement.operation) {
                            var payloadRestriction = this.restrictionManagement.operation
                                .restriction;
                            //Copy index back because of the backend returns response without one.
                            restrictionEdited.$restrictionIndex =
                                payloadRestriction.$restrictionIndex;
                        }
                        ...
                        if (restrictionIndex !== -1) {
                            ...
                            throw 'restrictionsEditorController - edited restriction not found in list: ' +
                                restrictionEdited;
                        }
                        this.sliderPanelHide();
                    }.bind(this)
        ...
        this.onClickOnAdd = function() {
            ...
            this.restrictionManagement.operation = restrictionPickerConfig.getConfigForSelecting(
                lodash.clone(this.restrictions),
        ...
        this.onClickOnEdit = function(restriction) {
            ...
            this.restrictionManagement.operation = restrictionPickerConfig.getConfigForEditing(
                lodash.clone(restriction),
                this.getSupportedRestrictionTypes
            );
            this.sliderPanelShow();
        }.bind(this);
        ...
        this._propagateErrors = function(eventId, genericEditorId) {
            var restrictionInEditMode =
                this.restrictionManagement.operation &&
                this.restrictionManagement.operation.mode ===
                    restrictionPickerConfig.MODE_EDITING &&
                genericEditorId === ITEM_MANAGEMENT_EDITOR_ID;
            if (restrictionInEditMode) {
                var restrictionIndex = this.restrictionManagement.operation.restriction
                    .$restrictionIndex;
                ...
                this._clearEvents();
                systemEventService
                    .publishAsync(GENERIC_EDITOR_UNRELATED_VALIDATION_MESSAGES_EVENT, {
        ...
        this._initEvents = function() {
            this.unregisterErrorListener = systemEventService.subscribe(
                GENERIC_EDITOR_UNRELATED_VALIDATION_MESSAGES_EVENT,
                this._handleUnrelatedValidationErrors.bind(this)
            );
            this.unregisterErrorPropagationEvent = systemEventService.subscribe(
                GENERIC_EDITOR_LOADED_EVENT,
                this._propagateErrors.bind(this)
            );
        };
            ...
            this.restrictions.forEach(
                function(restriction) {
                    if (!lodash.isNil(restriction.uid)) {
                        contextAwareEditableItemService.isItemEditable(restriction.uid).then(
                            function(isEditable) {
        ...
        this.$onInit = function() {
            ...
            this.sliderPanelConfiguration = {
                ...
                template:
                    ...
                    'data-config="restrictionManagement.operation" ' +
                    'data-uri-context="restrictionManagement.uriContext" ' +
                    'class="se-se-add-restriction-panel__restriction-management" ' +
                    'data-submit-fn="restrictionManagement.submitFn" ' +
                    'data-is-dirty-fn="restrictionManagement.isDirtyFn"' +
                    '>' +
                    '</restriction-management>',
                scope: null
            };
            ...
            this.sliderPanelConfiguration.scope = {
                restrictionManagement: this.restrictionManagement
            };
            ...
            this.isDirtyFn = function() {
                return (
                    ...
                    (this.matchCriteriaIsDirty && this.restrictions.length >= 2)
                );
            }.bind(this);
        ...
        this.$doCheck = function() {
            this.restrictionsArrayIsDirty =
                angular.toJson(this.originalRestrictions) !== angular.toJson(this.restrictions);

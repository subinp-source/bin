...
angular
    ...
    .controller('slotDisabledComponentController', function(
        ...
        var EXTERNAL_SLOT_DECORATOR_MSG_VERSIONING_MODE =
        ...
        this._checkIfSlotIsInherited = function() {
            ...
            pageInfoService.getCatalogVersionUUIDFromPage().then(
                function(uuid) {
        ...
        this.getPopoverMessage = function() {
            ...
            if (this.isVersioningPerspective) {
                msgToLocalize = this.isExternalSlot
                    ? EXTERNAL_SLOT_DECORATOR_MSG_VERSIONING_MODE
                    : DEFAULT_DECORATOR_MSG_VERSIONING_MODE;
            } else {
                msgToLocalize = this.isExternalSlot
                    ? EXTERNAL_SLOT_DECORATOR_MSG

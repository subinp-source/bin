...
angular
    ...
    .controller('slotSharedButtonController', function(
        ...
        this.$onInit = function() {
            ...
            slotSharedService.isSlotShared(this.slotId).then(
                function(result) {
        ...
        this.convertToNonSharedSlotAndCloneComponents = function() {
            slotSharedService.convertSharedSlotToNonSharedSlot(this.slotAttributes, true).then(
                function() {
                    this.isPopupOpened = false;
        ...
        this.convertToNonSharedSlotAndRemoveComponents = function() {
            slotSharedService.convertSharedSlotToNonSharedSlot(this.slotAttributes, false).then(
                function() {
                    this.isPopupOpened = false;
                    $window.location.reload();
                }.bind(this)

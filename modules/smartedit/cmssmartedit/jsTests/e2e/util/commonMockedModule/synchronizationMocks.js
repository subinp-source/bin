...
angular
    ...
    .run(function(httpBackendService, $window, lodash) {
        ...
        sessionStorage.setItem(
            ...
            JSON.stringify(trashedCategoryPageSyncStatus)
        );
        sessionStorage.setItem(
            'trashedContentPageSyncStatus',
            JSON.stringify(trashedContentPageSyncStatus)
        );
            ...
            .respond(function(method, url, data, headers) {
                ...
                if (id === 'syncedpageuid' || id === 'synchedPage') {
                    ...
                    return [
                        200,
                        lodash.cloneDeep(
                            JSON.parse(sessionStorage.getItem('trashedCategoryPageSyncStatus'))
                        )
                    ];
                    ...
                    return [
                        200,
                        lodash.cloneDeep(
                            JSON.parse(sessionStorage.getItem('trashedContentPageSyncStatus'))
                        )
                    ];
        ...
        httpBackendService
            .whenPOST(
                /\/cmssmarteditwebservices\/v1\/sites\/apparel-uk\/catalogs\/apparel-ukContentCatalog\/versions\/Staged\/synchronizations\/versions\/Online/
            )
            .respond(function(method, url, data, headers) {
                ...
                var status =
                    items.indexOf('trashedCategoryPage') > -1
                        ? JSON.parse(sessionStorage.getItem('trashedCategoryPageSyncStatus'))
                        : JSON.parse(sessionStorage.getItem('syncStatus'));
                ...
                if (
                    ...
                    newlyCreatedPageSyncStatus.lastSyncStatus = new Date(
                        2016,
                        10,
                        10,
                        13,

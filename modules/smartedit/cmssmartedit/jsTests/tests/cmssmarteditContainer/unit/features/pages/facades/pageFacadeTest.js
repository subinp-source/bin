...
describe('pageFacade', function() {
    ...
    var mocks, resource, mockCreatePageForSiteResource, restServiceFactory, service, $q;
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('pageFacadeModule')
            ...
            .and.returnValue(mockCreatePageForSiteResource)
        ...
        mockCreatePageForSiteResource = jasmine.createSpyObj('mockCreatePageForSiteResource', [
            'save'
        ]);
    });
    ...
    describe('contentPageWithLabelExists', function() {
        it('will return a promise resolving to true if the content page with given label exists', function() {
            ...
            expect(
                service.contentPageWithLabelExists(
                    MOCK_PAGE.label,
                    MOCK_CATALOG_VERSION.catalogId,
                    MOCK_CATALOG_VERSION.version
                )
            ).toBeResolvedWithData(true);
        });
    ...
    describe('createPage', function() {
        ...
        it('will send the EVENTS.PAGE_CREATED event on successful creation', function() {
            ...
            service.createPage(page).then(function() {
                expect(mocks.crossFrameEventService.publish).toHaveBeenCalledWith(
                    'PAGE_CREATED_EVENT',
                    page
                );
            });

        ...
        var harness = AngularUnitTestHelper.prepareModule('displayConditionsPageVariationsModule')
            .withTranslations({
                ...
                'se.cms.display.conditions.variation.pages.title':
                    'Variation Pages Associated to this Primary',
                ...
                'se.cms.display.conditions.no.variations':
                    'There are no page variations for this primary.'
            })
            .component(
                '<display-conditions-page-variations data-variations="variations"></display-conditions-page-variations>',
                {

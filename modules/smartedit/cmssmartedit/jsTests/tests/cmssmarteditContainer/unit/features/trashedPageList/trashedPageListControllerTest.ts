...
describe('TrashedPageListController - ', () => {
    ...
    const urlService: jasmine.SpyObj<IUrlService> = jasmine.createSpyObj<IUrlService>(
        'urlService',
        ['buildUriContext']
    );
    const catalogService: jasmine.SpyObj<ICatalogService> = jasmine.createSpyObj<ICatalogService>(
        'catalogService',
    ...
    const catalogVersionPermissionService: any = jasmine.createSpyObj<any>(
    ...
    const $scope: jasmine.SpyObj<angular.IScope> = jasmine.createSpyObj<angular.IScope>('$scope', [
        '$on'
    ]);

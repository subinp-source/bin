...
describe('seCatalogInformationService', function() {
    ...
    beforeEach(inject(function(_$rootScope_, $q) {
        ...
        mocks.productCategoryService.getCategoryById.and.returnResolvedPromise(
    ...
    it(
        ...
        function() {
            ...
            var promise = categoriesFetchStrategy.fetchPage(
                catalogInfo,
                mask,
                pageSize,
                currentPage
            ...
            // THEN
            promise.then(function(result) {
                expect(mocks.productCategoryService.getCategories).toHaveBeenCalledWith({
    ...
    it(
        ...
        function() {
            ...
            // THEN
            promise.then(function(result) {
                expect(mocks.productCategoryService.getCategoryById).toHaveBeenCalledWith(
                    SITE_1_UID,
                    categoryId
                );
                expect(result).toEqual({

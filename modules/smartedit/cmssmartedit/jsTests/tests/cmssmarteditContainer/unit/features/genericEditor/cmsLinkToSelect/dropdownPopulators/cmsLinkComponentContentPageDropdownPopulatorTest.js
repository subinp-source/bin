...
describe('cmsLinkComponentcontentPageDropdownPopulator', function() {
    ...
    beforeEach(function() {
        expectItemUri = PAGES_LIST_RESOURCE_URI.replace(
            /:catalogId/gi,
        ...
        var harness = AngularUnitTestHelper.prepareModule(
            ...
            .mock('contextAwareCatalogService', 'getContentPageSearchUri')
            .and.returnResolvedPromise(expectedSearchUri)
            .mock('contextAwareCatalogService', 'getContentPageItemUri')
            .and.returnResolvedPromise(expectItemUri)
            ...
            .and.returnResolvedPromise(PAGES_MOCKS[0])

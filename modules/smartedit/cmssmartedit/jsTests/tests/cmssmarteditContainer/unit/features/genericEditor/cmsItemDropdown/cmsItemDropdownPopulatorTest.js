...
describe('cmsItemDropdownPopulatorTest', function() {
    ...
    // ---------------------------------------------------------------
    beforeEach(
        angular.mock.module('dropdownPopulatorModule', function($provide) {
            ...
            DropdownPopulatorInterface.prototype = jasmine.createSpyObj(
                'DropdownPopulatorInterfacePrototype',
                ['fetchAll', 'fetchPage', 'getItem']
            );

            uriDropdownPopulator = jasmine.createSpyObj('uriDropdownPopulator', [
                'fetchAll',
                'fetchPage',
                'getItem'
            ]);
    ...
    beforeEach(function() {
        var harness = AngularUnitTestHelper.prepareModule('cmsItemDropdownDropdownPopulatorModule')
            .mock('genericEditorStackService', 'getEditorsStack')
            .and.returnValue([
                {
                    component: {
                        uuid: 'comp3'

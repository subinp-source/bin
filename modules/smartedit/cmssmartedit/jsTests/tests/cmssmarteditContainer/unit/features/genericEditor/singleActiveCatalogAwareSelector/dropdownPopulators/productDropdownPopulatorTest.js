...
describe('productDropdownPopulator', function() {
    ...
    beforeEach(function() {
        expectedSearchUri = PRODUCT_LIST_RESOURCE_API.replace(
            /:catalogId/gi,
        ...
        var harness = AngularUnitTestHelper.prepareModule('productDropdownPopulatorModule')
            .mock('contextAwareCatalogService', 'getProductSearchUri')
            .and.returnResolvedPromise(expectedSearchUri)
            .mock('contextAwareCatalogService', 'getProductItemUri')
            ...
            .and.returnResolvedPromise(PRODUCTS_MOCK[0])

...
describe('componentVisibilityAlert', function() {
    ...
    describe('checkAndAlertOnComponentVisibility - component not editable', function() {
        ...
        it("should display a 'will not be displayed' alert for any hidden component", function() {
            ...
            componentVisibilityAlertService.checkAndAlertOnComponentVisibility(
                _getMockPayload('HIDDEN_NO_RESTRICTIONS')
            );
        ...
        it("should display a 'will not be displayed' alert for any hidden and restricted component", function() {
            // Act
            componentVisibilityAlertService.checkAndAlertOnComponentVisibility(
                _getMockPayload('HIDDEN_WITH_RESTRICTIONS')
            );
            fixture.detectChanges();
        ...
        it("should display a 'might not be displayed' alert for any restricted component", function() {
            // Act
            componentVisibilityAlertService.checkAndAlertOnComponentVisibility(
                _getMockPayload('VISIBLE_WITH_RESTRICTIONS')
            );
            fixture.detectChanges();
    ...
    describe('checkAndAlertOnComponentVisibility - component editable', function() {
        ...
        it("should display a 'will not be displayed' alert for any hidden component", function() {
            ...
            var controller = mockActionableAlertService.displayActionableAlert.calls.argsFor(0)[0]
                .controller[2];
            var controllerInstance = new controller(
                componentVisibilityAlertService,
                mockEditorModalService
            );
            ...
            // Assert
            expect(controllerInstance.description).toBe(
                'se.cms.component.visibility.alert.description.hidden'
            );
            expect(controllerInstance.hyperlinkLabel).toBe(
                'se.cms.component.visibility.alert.hyperlink'
            );
        ...
        it("should display a 'might not be displayed' alert for any restricted component", function() {
            ...
            expect(controllerInstance.description).toBe(
                'se.cms.component.visibility.alert.description.restricted'
            );
        });
        ...
        it('should throws an exception if provided itemId is not of string type', function() {
            // Act
            componentVisibilityAlertService.checkAndAlertOnComponentVisibility(
                lodash.omit(_getMockPayload('VISIBLE_WITH_RESTRICTIONS'), 'itemId')
            );
            fixture.detectChanges();
        ...
        it('should throws an exception if provided itemType is not of string type', function() {
            // Act
            componentVisibilityAlertService.checkAndAlertOnComponentVisibility(
                lodash.omit(_getMockPayload('VISIBLE_WITH_RESTRICTIONS'), 'itemType')
            );
            fixture.detectChanges();
        ...
        it('should throws an exception if provided slotId is not of string type', function() {
            // Act
            componentVisibilityAlertService.checkAndAlertOnComponentVisibility(
                lodash.omit(_getMockPayload('VISIBLE_WITH_RESTRICTIONS'), 'slotId')
            );
            fixture.detectChanges();
        ...
        it("should trigger 'editorModalService.openAndRerenderSlot' when all expected parameters are properly provided", function() {
            ...
            mockEditorModalService.openAndRerenderSlot.and.returnValue(
                $q.when({
                    visible: false,
                    restricted: true
                })
        ...
        it("should trigger 'editorModalService.openAndRerenderSlot' when all expected parameters are properly provided", function() {
            ...
            expect(
                componentVisibilityAlertService.checkAndAlertOnComponentVisibility
            ).toHaveBeenCalledWith(_getMockPayload('HIDDEN_WITH_RESTRICTIONS'));
        });
    });
});

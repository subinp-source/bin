...
describe('pageListController for a non active catalogVersion', function() {
    ...
    beforeEach(function() {
        var harness = AngularUnitTestHelper.prepareModule('pageListControllerModule')
            .mock('urlService', 'buildUriContext')
            .and.returnValue(uriContext)
            .mock('urlService', 'buildPageUriContext')
            .and.returnValue(pageUriContext)
            ...
            .and.returnResolvedPromise('')
            .mock('pageEditorModalService', 'open')
            .and.returnResolvedPromise('')
            .mock('sharedDataService', 'set')
            .and.returnResolvedPromise('')
            ...
            .mock('managePageService', 'getSoftDeletedPagesCount')
            .and.returnResolvedPromise(2)
            .mock('experienceService', 'loadExperience')
            .mock('catalogVersionPermissionService', 'hasSyncPermissionToActiveCatalogVersion')
            .and.returnResolvedPromise(true)
    ...
    describe('init', function() {
        ...
        it('should initialize event subscriptions', function() {
            expect(mocks.systemEventService.subscribe).toHaveBeenCalledWith(
                MOCKED_EVENT_NAME,

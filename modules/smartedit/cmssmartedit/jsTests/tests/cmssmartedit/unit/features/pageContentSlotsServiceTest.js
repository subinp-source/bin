...
describe('pageContentSlotsService', function() {
    ...
    beforeEach(function() {
        mockPagesContentSlotsResource = jasmine.createSpyObj('mockPagesContentSlotsResource', [
            'get'
        ]);
    });
    ...
    beforeEach(function() {
        harness = AngularUnitTestHelper.prepareModule('pageContentSlotsServiceModule')
            ...
            .and.returnValue(mockPagesContentSlotsResource)
        ...
        expect(mockCrossFrameEventService.subscribe).toHaveBeenCalledWith(
            'PAGE_CHANGE',
    ...
    describe('_reloadPageContentSlots ', function() {
        it('should resolve with a list of page content slots', function() {
            $rootScope.$digest();
            expect(pageContentSlotsService._reloadPageContentSlots()).toBeResolvedWithData(
                pagescontentslots.pageContentSlotList
            );
        });
    ...
    describe('getPageContentSlots ', function() {
        it('should resolve with a list of page content slots', function() {
            $rootScope.$digest();
            expect(pageContentSlotsService.getPageContentSlots()).toBeResolvedWithData(
                pagescontentslots.pageContentSlotList
            );
        });
    });

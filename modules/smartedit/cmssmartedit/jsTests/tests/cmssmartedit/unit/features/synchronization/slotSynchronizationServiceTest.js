...
describe('slot synchronization service - ', function() {
    ...
    it(
        ...
        function() {
            ...
            expect(promise).toBeResolvedWithData(
                window.smarteditJQuery.extend(slot1_syncStatus, {
    ...
    it(
        ...
        function() {
            ...
            //THEN
            expect(promise).toBeResolvedWithData(
                window.smarteditJQuery.extend(slot3_syncStatus, {
                    selectAll: 'se.cms.synchronization.slots.select.all.components'
                })
            );
        }
    ...
    it(
        ...
        function() {
            ...
            //THEN
            expect(mockSyncPollingService.performSync).toHaveBeenCalledWith(
                pageSyncStatus,
                uriContext
            );
        }

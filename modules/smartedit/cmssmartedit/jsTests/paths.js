...
module.exports = (function() {
    ...
    paths.tests.cmssmarteditContainerUnitTestsRoot =
        paths.tests.cmssmarteditContainerTestsRoot + '/unit';
    paths.tests.cmssmarteditContainere2eTestsRoot =
        paths.tests.cmssmarteditContainerTestsRoot + '/e2e';
    ...
    paths.tests.cmssmarteditContainerSpecBundle =
        paths.tests.cmssmarteditContainerUnitTestsRoot + '/specBundle.ts';
    paths.tests.cmssmartedite2eTestFiles = paths.tests.root + '/e2e/**/*Test.js';

    paths.tests.allE2eTSMocks = [
        paths.tests.root + '/e2e/**/inner*.ts',
        paths.tests.root + '/e2e/**/outer*.ts'
    ];
    paths.tests.cmssmarteditContainere2eTestFiles =
        paths.tests.cmssmarteditContainere2eTestsRoot + '/**/*Test.js';
    ...
    paths.sources.cmssmarteditContainerFiles =
        paths.sources.features + '/cmssmarteditContainer/**/*.js';
    paths.sources.cmssmarteditContainerTSFiles =
        paths.sources.features + '/cmssmarteditContainer/**/*.ts';
    ...
    paths.target.cmssmarteditTemplatesFile =
        paths.target.features + '/cmssmartedit/**/templates.js';
    paths.target.cmssmarteditContainerTemplatesFile =
        paths.target.features + '/cmssmarteditContainer/**/templates.js';
    ...
    paths.target.cmssmarteditContainerFiles =
        paths.target.features + '/cmssmarteditContainer/**/*.js';
    paths.target.cmssmarteditContainerTSFiles =
        paths.target.features + '/cmssmarteditContainer/**/*.ts';

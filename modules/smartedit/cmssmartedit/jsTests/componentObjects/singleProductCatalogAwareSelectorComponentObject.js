...
module.exports = (function() {
    ...
    componentObject.assertions = {
        ...
        productIsPopulated: function() {
            expect(componentObject.elements.getProductItems().count()).not.toBe(
                0,
        ...
        productIsNotPopulated: function() {
            expect(componentObject.elements.getProductItems().count()).toBe(
                0,
                'Expected product not to be populated'
            );
        },
        categoryIsPopulated: function() {
            expect(componentObject.elements.getCategoryItems().count()).not.toBe(
                0,
        ...
        categoryIsNotPopulated: function() {
            expect(componentObject.elements.getCategoryItems().count()).toBe(
                0,
    ...
    componentObject.actions = {
        selectProductCatalog: function() {
            ...
            return yDropDownComponent.actions.selectDropdownItemByText(
                el,
    ...
    componentObject.elements = {
        getProductCatalogField: function() {
            return browser.findElement(
                by.css('se-dropdown[data-id="se-catalog-selector-dropdown"] y-select'),
                false
            );
        },
        ...
        getProductField: function() {
            return browser.findElement(
                by.css('se-dropdown[data-id="se-items-selector-dropdown"] y-select')
            );
        },

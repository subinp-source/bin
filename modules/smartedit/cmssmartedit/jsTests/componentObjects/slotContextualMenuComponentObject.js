...
module.exports = (function() {
    ...
    componentObject.elements = {
        ...
        hiddenComponentInSlot: function(slotId, componentId) {
            return this.visibilityDropdownBySlotId(slotId).element(
                by.css('slot-visibility-component[data-component-id="' + componentId + '"]')
            );
        },
        hiddenComponentMenuButton: function(slotId, componentId) {
            return this.hiddenComponentInSlot(slotId, componentId).element(
                by.css('hidden-component-menu .se-hidden-component-menu__popup-anchor')
            );
        },
    ...
    componentObject.assertions = {
        ...
        assertThatSlotSharedButtonOverrideLinksToBeAbsent: function(slotId) {
            var cloneLinks = componentObject.elements.sharedSlotMessageButtonCloneLinksBySlotId(
                slotId
            );

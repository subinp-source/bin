...
module.exports = (function() {
    var co = {
        ...
        SYNC_PANEL_HEADER_HELPER: 'page-synchronization-header se-help ',
        ...
        SYNC_ITEMS_CHECKBOX_SELECTOR:
            'synchronization-panel .se-sync-panel__sync-info__row div label',
        ...
        hoverHelp: function() {
            return browser
                .actions()
                .mouseMove(element(by.css(this.SYNC_PANEL_HEADER_HELPER)))
                .perform();
        },
        getSyncItemDependenciesContent: function() {
            browser.waitUntil(function() {
                return element
                    .all(by.css('.popover .se-popover__content'))
        ...
        getSyncItemsStatus: function() {
            return element
                .all(by.css(this.SYNC_ITEMS_SELECTOR + ' span.se-sync-panel__sync-info-icon'))
        ...
        assertPanelIsready: function() {
            return browser.waitForPresence(
                by.cssContainingText('synchronization-panel button', 'Sync'),
    ...
    co.elements = {
        syncStatusIconBySlotName: function(slotName, status) {
            ...
            var xp =
                "//*[contains(@class, 'se-sync-panel__sync-info__row')]//*[contains(text(), '" +
                slotName +
        ...
        syncNotAllowedWarningMessage: function() {
            ...
            return element(
                by.cssContainingText(
                    'synchronization-panel se-message .y-message-info-description',
                    expectedMessage
                )
            );
        }

...
module.exports = (function() {
    ...
    restrictionsEditor.elements = {
        ...
        getAnyRestrictionOption: function() {
            return element(
                by.cssContainingText('.se-restriction__select li div', 'Apply any restriction')
            );
        },
            ...
            return element(
                by.css(
                    restrictionsEditor.constants.RESTRICTION_TYPE_SELECTOR_ID +
                        ' .se-generic-editor-dropdown__match2'
                )
            );
        },
        getRestrictionTypeOption: function(optionValue) {
            return element(
                by.cssContainingText(
                    restrictionsEditor.constants.RESTRICTION_TYPE_SELECTOR_ID + ' ul li span',
                    optionValue
                )
            );
        },
        getRestrictionsSearchBox: function() {
            return element(
                by.css(
                    restrictionsEditor.constants.RESTRICTION_NAME_SELECTOR_ID + ' .ui-select-toggle'
                )
            );
        },
        getRestrictionsSearchBoxInput: function() {
            return element(
                by.css(
                    restrictionsEditor.constants.RESTRICTION_NAME_SELECTOR_ID + ' .ui-select-search'
                )
            );
        },
        getRestrictionSearchBoxOption: function(optionValue) {
            return element(
                by.cssContainingText(
                    restrictionsEditor.constants.RESTRICTION_NAME_SELECTOR_ID + ' ul li span',
                    optionValue
                )
            );
        },
    ...
    restrictionsEditor.assertions = {
        ...
        timeRestrictionIsInEditMode: function() {
            ...
            expect(restrictionsEditor.elements.getRestrictionNameField().isPresent()).toBe(
                true,
                'Expected nameField to be present in edit mode'
            );
            expect(

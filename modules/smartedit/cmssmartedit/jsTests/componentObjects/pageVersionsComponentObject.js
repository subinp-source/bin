    ...
    componentObject.elements = {
        ...
        getPageVersionsMenu: function() {
            return browser.findElement(
                by.css('[data-item-key="se.cms.pageVersionsMenu"] page-versions-menu')
            );
        },
        ...
        getVersionsCount: function() {
            return this.getPageVersionsMenu()
                .element(by.css('.se-version-panel__count'))
                .getText();
        },
        getSearchBox: function() {
            return this.getPageVersionsMenu().element(
                by.css('.se-version-panel__search .se-input-group__input-area')
            );
        },

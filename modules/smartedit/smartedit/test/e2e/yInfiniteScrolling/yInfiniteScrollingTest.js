...
describe('yInfiniteScrolling', function() {
    ...
    var ITEMS_SET_3 = ['21 : item21', '22 : item22', '23 : item23', '24 : item24', '25 : item25'];
    ...
    beforeEach(function() {
        browser.get('test/e2e/yInfiniteScrolling/index.html');
    });
    ...
    it('WILL display more results as we scroll the list of existing items names/types in second tab', function() {
        ...
        browser.scrollToBottom(yInfiniteScrolling.getItemsScrollElement()).then(function() {
            ...
            browser.scrollToBottom(yInfiniteScrolling.getItemsScrollElement()).then(function() {
                yInfiniteScrolling.assertListOfItems(
                    ITEMS_SET_1.concat(ITEMS_SET_2).concat(ITEMS_SET_3)
                );
            });
        });
    });

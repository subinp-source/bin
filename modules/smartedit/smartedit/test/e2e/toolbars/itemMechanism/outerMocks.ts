        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService, windowUtils: WindowUtils) => {
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditContainerLocation":"/test/e2e/toolbars/itemMechanism/generated_outerapp.js"}',
                        key: 'applications.Outerapp'
                    },

                    {
                        value:
                            '{"smartEditLocation":"/test/e2e/toolbars/itemMechanism/generated_innerapp.js"}',
                ...
                httpBackendService
                    ...
                    .respond(function(method, url, data) {
                        const returnedPayload = {
                            ...
                            resourcePath:
                                'http://127.0.0.1:9000/test/e2e/toolbars/itemMechanism/iframe.html'
                        };

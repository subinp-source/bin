 ...
 */
angular
    .module('outerapp', ['ui.bootstrap', 'ngRoute', 'treeModule', 'confirmationModalServiceModule'])
    ...
    .directive('someTreeEditor', function() {
        return {
            ...
            replace: false,
            template:
                "<button id='outsideActionButton' data-ng-click='ctrl.actions.addSiblingToFirstChild()'>add sibling to first child</button>" +

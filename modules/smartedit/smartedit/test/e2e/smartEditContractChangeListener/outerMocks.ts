        ...
        moduleUtils.bootstrap(
            (httpBackendService: HttpBackendService) => {
                ...
                const map = [
                    ...
                    {
                        value:
                            '{"smartEditLocation":"/test/e2e/utils/commonMockedModules/generated_innerClickThroughOverlay.js"}',
                        key: 'applications.InnerClickThroughOverlay'
                    },
                    {
                        value:
                            '{"smartEditContainerLocation":"/test/e2e/utils/commonMockedModules/generated_outerClickThroughOverlay.js"}',
                        key: 'applications.OuterClickThroughOverlay'
                    },
                    {
                        value:
                            '{"smartEditLocation":"/test/e2e/smartEditContractChangeListener/generated_innerapp.js"}',

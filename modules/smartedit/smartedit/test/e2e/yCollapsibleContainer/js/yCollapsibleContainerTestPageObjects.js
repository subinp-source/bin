    ...
    var pageObjects = {
        ...
        assertions: {
            ...
            iconIsNotVisible: function() {
                expect(
                    browser.findElement('a.yCollapsibleContainer__icon', false).isDisplayed()
                ).toBe(false);
            },
            ...
            textTitleIsVisible: function() {
                expect(pageObjects.elements.getTitle().getText()).toContain(
                    'plain text as a title'
                );
            },

            /* [ content ] */
            contentIsVisible: function() {
                expect(pageObjects.elements.getContent().getAttribute('aria-expanded')).toBe(
                    'true'
                );
            },

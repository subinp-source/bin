...
module.exports = {
        ...
        if (cssClass === this.collapseButtonClass || cssClass === this.expandButtonClass) {
            return browser.click(
                by.xpath(
                    "//div/span[.='" +
                        nodeLabel +
                        "']/ancestor::div[2]/div/a/span[contains(@class, '" +
                        cssClass +
                        "')]"
                )
            );
            ...
            return browser.click(
                by.xpath(
                    "//div/span[.='" +
                        nodeLabel +
                        "']/ancestor::div[2]/a/span[contains(@class, '" +
                        cssClass +
                        "')]"
                )
            );
    ...
    getAndWaitForWholeApp: function() {
        browser.get('test/e2e/tree/index.html');
        browser.waitUntil(
    ...
    getChildrenNames: function(nodeLabel) {
        ...
        if (nodeLabel) {
            selector = by.xpath(
                "//div/span[.='" + nodeLabel + "']/ancestor::li[1]/ol/li/div/div[2]/span"
            );
        } else {

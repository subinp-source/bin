 ...
 *
 * @description
 * Deprecated, use {@link smarteditCommonsModule.component:InfiniteScrollingComponent}
...
export class YInfiniteScrollingComponent<T extends ITechnicalUniqueIdAware>
    implements ISeComponent {
    /** @internal */
    ...
    nextPage() {
        ...
        this.discardablePromiseUtils.apply(
            ...
            (page: Page<T>) => {
                ...
                const uniqueResults = this.lodash.differenceBy(
                    page.results,
                    this.context.items,
                    'technicalUniqueId' as keyof ITechnicalUniqueIdAware
                );
                ...
                this.$timeout(() => {
                    this.pagingDisabled =
                        ...
                        (page.pagination &&
                            this.context.items.length === page.pagination.totalCount);
                    // CMSX-10736: If the results fetched by this call is empty, fetch next page automatically.
                    if (this.context.items.length === 0 && page.pagination.page < page.pagination.totalPages) {

...
public class EntitlementbackofficeManager extends GeneratedEntitlementbackofficeManager
{
	 ...
	 */
	public EntitlementbackofficeManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EntitlementbackofficeManager called.");
		}
	}
	 ...
	 */
	public static EntitlementbackofficeManager getInstance()
	{
		return (EntitlementbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(EntitlementbackofficeConstants.EXTENSIONNAME);
	}
